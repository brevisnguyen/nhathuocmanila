<div class="relative overflow-hidden group shadow-md rounded-md">
    ...
    <div class="flex flex-col bg-slate-50 rounded-md group-hover:md:border-2 group-hover:md:border-lime-600">
        <picture class="aspect-square object-cover rounded-t-md">
            <source srcset="{{ $product->getFirstMediaUrl('products', 'medium') }}">
            <img class="aspect-square object-cover rounded-t-md" src="https://placehold.co/350x350">
        </picture>
        <div class="my-2 px-2">
            <a
        ...
        <button
            ...
            class="m-auto px-5 py-2 mb-2 flex items-center justify-center bg-lime-600 text-white rounded-lg"
        >
